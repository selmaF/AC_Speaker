...
def check_einarmhaengt(data):
    ...
    subcond_0rg = np.abs((data[data['part_names']=='leftElbow']['y'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['y'].reset_index(drop=True)))<40
    
    #höhenunterschied rightelbow-leftwrist kleiner als 40
    subcond_0lg = np.abs((data[data['part_names']=='rightElbow']['y'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['y'].reset_index(drop=True)))<40

    #rightwrist etwa auf höhe der hüfte
    subcond_1rg = np.abs((data[data['part_names']=='rightWrist']['y'].reset_index(drop=True))-(data[data['part_names']=='rightHip']['y'].reset_index(drop=True)))<50
    
    #leftwrist etwa auf höhe der hüfte
    subcond_1lg = np.abs((data[data['part_names']=='leftWrist']['y'].reset_index(drop=True))-(data[data['part_names']=='leftHip']['y'].reset_index(drop=True)))<50
    
    #leftwrist etwa auf höhe des leftelbow
    subcond_2rg = np.abs((data[data['part_names']=='leftWrist']['y'].reset_index(drop=True))-(data[data['part_names']=='leftElbow']['y'].reset_index(drop=True)))<30
    
    #rightwrist etwa auf höhe des rightelbow
    subcond_2lg = np.abs((data[data['part_names']=='rightWrist']['y'].reset_index(drop=True))-(data[data['part_names']=='rightElbow']['y'].reset_index(drop=True)))<30
    
    # rightwrist nahe an leftelbow (bzgl der xwerte)
    subcond_3lg = np.abs((data[data['part_names']=='rightWrist']['x'].reset_index(drop=True))-(data[data['part_names']=='leftElbow']['x'].reset_index(drop=True)))<40
    
    # leftwrist nahe an rightelbow (bzgl der xwerte)
    subcond_3rg = np.abs((data[data['part_names']=='leftWrist']['x'].reset_index(drop=True))-(data[data['part_names']=='rightElbow']['x'].reset_index(drop=True)))<40
    ...
    subcond_4lg = subcond_5lg['angle']

    res = (subcond_0rg & subcond_1rg & subcond_2rg & subcond_3rg & subcond_4rg) or (subcond_0lg & subcond_1lg & subcond_2lg & subcond_3lg & subcond_4lg)
...
def check_armgestreckt(data):
    ...
    subcond_0lg = np.abs((data[data['part_names']=='leftElbow']['y'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['y'].reset_index(drop=True)))<80
    
    #höhenunterschied rightelbow-rightwrist kleiner als 80
    subcond_0rg = np.abs((data[data['part_names']=='rightElbow']['y'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['y'].reset_index(drop=True)))<80

    #höhenunterschied leftshoulder-leftwrist  kleiner als 30
    subcond_1lg = np.abs((data[data['part_names']=='leftShoulder']['y'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['y'].reset_index(drop=True)))<70
    
    #höhenunterschied rightshoulder-rightwrist kleiner als 30
    subcond_1rg = np.abs((data[data['part_names']=='rightShoulder']['y'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['y'].reset_index(drop=True)))<70

    #xunterschied leftelbow-leftwrist  kleiner als  
    subcond_2lg = np.abs((data[data['part_names']=='leftElbow']['x'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['x'].reset_index(drop=True)))<70
    
    #xunterschied rightelbow-rightwrist kleiner als 
    subcond_2rg = np.abs((data[data['part_names']=='rightElbow']['x'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['x'].reset_index(drop=True)))<70

    #xunterschied leftshoulder-leftwrist  kleiner als 
    subcond_3lg = np.abs((data[data['part_names']=='leftShoulder']['x'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['x'].reset_index(drop=True)))<50
    
    #xunterschied rightshoulder-rightwrist kleiner als 
    subcond_3rg = np.abs((data[data['part_names']=='rightShoulder']['x'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['x'].reset_index(drop=True)))<50

    res = (subcond_0rg & subcond_1rg & subcond_2rg & subcond_3rg) | (subcond_0lg & subcond_1lg & subcond_2lg & subcond_3lg)
...
def check_gesichtverdeckt(data):
    ...
    subcond_0lv = np.abs((data[data['part_names']=='nose']['y'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['y'].reset_index(drop=True)))<130
    
    #höhenunterschied nose-rightwrist kleiner als 130
    subcond_0rv = np.abs((data[data['part_names']=='nose']['y'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['y'].reset_index(drop=True)))<130

    #xunterschied nose-leftwrist  kleiner als 60 
    subcond_1lv = np.abs((data[data['part_names']=='nose']['x'].reset_index(drop=True))-(data[data['part_names']=='leftWrist']['x'].reset_index(drop=True)))<80
    
    #xunterschied nose-rightwrist kleiner als 60
    subcond_1rv = np.abs((data[data['part_names']=='nose']['x'].reset_index(drop=True))-(data[data['part_names']=='rightWrist']['x'].reset_index(drop=True)))<80
