...
def find_frames(section_name, audio_frame, audio_files_path, data_whole_file):
    ...
    analyzer_section = a.AudioAnalyzer(section_name, audio_frame, audio_files_path)
    analyzer_section.analyze()
...
if __name__ == '__main__':
    ...
    try:
        ...
        first_audio = "redeTed.wav"     # TODO: show error message (Daria)
    audio_files_path = "data/myprosody/audioFiles"

    analyzer = a.AudioAnalyzer(first_audio, first_audio, audio_files_path)
    analyzer.analyzeWholeFile()
